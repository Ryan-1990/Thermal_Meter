...
public:
  ...
  COLORREF m_crAlertColor_Low;        // alert line color
  COLORREF m_crAlertColor_High;        // alert line color
...
protected:
  ...
  CBitmap *m_pbitmapOldAlert;
  CBitmap m_bitmapGrid;
  CBitmap m_bitmapPlot;
  CBitmap m_bitmapAlert;
